...
12. **Chain to `/gaia-plan`.** `AskUserQuestion`: trigger `/gaia-plan` now or defer. On yes, you can author one or more plans, one per slice of the spec. The session stays light no matter how many you create.
