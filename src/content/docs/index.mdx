...
Follow along with the `/gaia-init` [walkthrough](/getting-started/gaia-init/). Once setup is done, [Working in GAIA](/getting-started/working-in-gaia/) shows how a normal session works.
