...
Without GAIA CI, the wiki doesn't update on its own. GAIA watches for drift and nudges you when it accumulates (at prompt submission and at session end). You then run `/gaia
wiki` to bring it back in sync.
