...
The card self-sizes. The box width tracks the longest content line, capped at 120 columns or the terminal width (whichever is smaller) and floored wide enough to keep the category names and grades from colliding. Remediation text wraps to fit.
